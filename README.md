...
Kontribusi selalu disambut dengan baik! Jika Anda memiliki ide penambahan ruangan baru (*misal: Das Badezimmer / Kamar Mandi*), perbaikan kosakata, atau penyempurnaan UI:
1. *Fork* repositori ini
2. Buat branch fitur baru (`git checkout -b feature/fitur-baru`)
3. *Commit* perubahan Anda (`git commit -m 'Menambahkan fitur kuis baru'`)
...
Proyek ini dilisensikan di bawah lisensi [MIT](LICENSE). Silakan gunakan dan modifikasi untuk keperluan belajar maupun pengembangan non-komersial/komersial.
